...
class Hustle_Provider_Admin_Ajax {
   ...
   private static $_instance = null;
	...
	public function settings() {
		...
		$check_required_fields_missing = $this->check_required_fields( $sanitized_post_data, [ 'slug', 'step', 'current_step' ] );
	...
	public function form_settings() {
		...
		$sanitized_post_data = $this->get_sanitized_submitted_data( [ 'module_id' => 'FILTER_VALIDATE_INT' ] );

		$check_required_fields_missing = $this->check_required_fields( $sanitized_post_data, [ 'slug', 'step', 'current_step', 'module_id' ] );
	 ...
	 * @return array
	 */
	private function get_sanitized_submitted_data( $extra_base_filters = [] ) {
