...
class Hustle_Addon_Aweber_Oauth {
	...
	public static function create_signature_base( $method, $url, $data ) {
		 ...
		 */
		$signature_base = apply_filters( 'hustle_addon_aweber_oauth_signature_base', $signature_base, $request_method, $request_url, $request_data );
	...
	public static function create_signature( $base, $key ) {
		 ...
		 * @param string $key
		 */
		$signature = apply_filters( 'hustle_addon_aweber_oauth_signature', $signature, $base, $key );
	...
	public static function create_signature_key( $application_key, $oauth_token_secret ) {
		 ...
		 */
		$signature_key = apply_filters( 'hustle_addon_aweber_oauth_signature_key', $signature_key, $application_key, $oauth_token_secret );
