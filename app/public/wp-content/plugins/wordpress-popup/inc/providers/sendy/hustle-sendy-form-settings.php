 ...
 */
	...
	public function first_step_callback( $submitted_data ) {
		...
		$message = sprintf( esc_html__( "Sendy is activated for this module.%sRemember:%s if you add new fields or change the default fields' names from the Hustle form, you must add them in your Sendy dashboard as well for them to be added.", 'hustle' ), '<br/><b>', '</b>' );
