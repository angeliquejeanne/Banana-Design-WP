	...
	<div role="dialog"
		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-header sui-block-content-center">
				...
				<h3 id="dialogTitle" class="sui-box-title"><?php esc_html_e( 'Edit Field', 'hustle' ); ?></h3>
			...
			<div class="sui-box-footer">
				...
				<button class="sui-button sui-button-ghost hustle-discard-changes">
					<i class="sui-icon-undo" aria-hidden="true"></i> <?php esc_attr_e( 'Discard Changes', 'hustle' ); ?>
				</button>
				...
				<div class="sui-actions-right">
					...
					<button id="hustle-apply-changes" class="sui-button">
						<span class="sui-loading-text">
							<i class="sui-icon-check" aria-hidden="true"></i> <?php esc_attr_e( 'Apply', 'hustle' ); ?>
						</span>
				...
				<# if ( 'email' !== type ) { #>
					...
					<div class="sui-side-tabs" style="margin-top: 10px;">
						...
						<div class="sui-tabs-content">
							...
							<div class="sui-tab-boxed{{ _.isTrue( validate ) ? ' active' : '' }}" data-tab-content="validate">
		...
		<div class="sui-box-settings-col-2">
			...
			<div class="sui-side-tabs" style="margin-top: 10px;">
				...
				<input
					...
					value="<?php echo implode( ',', $available_recaptchas ); ?>"
				/>
			</div>
