...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<label class="sui-toggle hustle-toggle-with-container" data-toggle-on="unsub-email">
			<input type="checkbox"
				name="email_enabled"
				value="1"
		...
		<label class="sui-toggle-label" for="wph-unsub-edit-email"><?php esc_html_e( 'Enable custom email copy', 'hustle' ); ?></label>
		...
		<div class="sui-border-frame sui-toggle-content" data-toggle-content="unsub-email" style="display:none;">
			...
			<div class="sui-form-field">
				...
				<span class="sui-description"><?php printf( esc_html__( 'Use the placeholder %1$s{hustle_unsubscribe_link}%2$s to insert the unsubscription link.', 'hustle' ), '<strong>', '</strong>' ); ?></span>
