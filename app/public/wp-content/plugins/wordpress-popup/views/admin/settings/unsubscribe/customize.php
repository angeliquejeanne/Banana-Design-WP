...
<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<label class="sui-toggle hustle-toggle-with-container" data-toggle-on="unsub-messages">
			<input type="checkbox"
				...
				>
			<label for="hustle-unsub-edit-message" class="sui-toggle-slider"></label>
		</label>
		<label class="sui-toggle-label" for="hustle-unsub-edit-message"><?php esc_html_e( 'Enable form customization', 'hustle' ); ?></label>
