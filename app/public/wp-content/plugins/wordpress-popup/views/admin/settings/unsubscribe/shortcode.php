<div class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		<span class="sui-description"><?php esc_html_e( 'By default, the Unsubscribe form works for all the modules. If you want to let visitors unsubscribe from specific modules only, add the comma separated module ids in the id attribute.', 'hustle' ); ?></span>
		<span class="sui-description"><?php printf( esc_html__( 'You can find the module\'s ID in the URL of the module\'s wizard page: %s.', 'hustle' ), '/wp-admin/admin.php?page=hustle_popup&<b>id=58</b>' ); ?></span>
